...
class Tada(
    ...
    private val keyframes = listOf(
        Keyframe.Segment(
            ...
            to = TransformProperties(scaleX = minScale, scaleY = minScale, rotationZ = -rotationAngle),
            easing = ease
        ),
        Keyframe.Segment(
            start = 0.1f,
            end = 0.2f,
            from = TransformProperties(scaleX = minScale, scaleY = minScale, rotationZ = -rotationAngle),
            to = TransformProperties(scaleX = minScale, scaleY = minScale, rotationZ = -rotationAngle),
            easing = ease
        ),
        Keyframe.Segment(
            ...
            from = TransformProperties(scaleX = minScale, scaleY = minScale, rotationZ = -rotationAngle),
            to = TransformProperties(scaleX = maxScale, scaleY = maxScale, rotationZ = rotationAngle),
            easing = ease
        ),
        Keyframe.Segment(
            start = 0.3f,
            end = 0.4f,
            from = TransformProperties(scaleX = maxScale, scaleY = maxScale, rotationZ = rotationAngle),
            to = TransformProperties(scaleX = maxScale, scaleY = maxScale, rotationZ = -rotationAngle),
            easing = ease
        ),
        Keyframe.Segment(
