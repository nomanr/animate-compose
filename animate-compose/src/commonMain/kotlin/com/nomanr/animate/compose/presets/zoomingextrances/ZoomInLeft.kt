...
class ZoomInLeft(
    private val peakOffsetX: Float = -400f,
    private val prePeakDelta: Float = 20f,
    private val overshootOffsetX: Float = 10f,
) : AnimationPreset {
    ...
    private val startOffsetX = peakOffsetX + prePeakDelta

    private val keyframes = listOf(
        Keyframe.Segment(
            start = 0f, end = 0.2f, from = TransformProperties(
            ...
            start = 0.2f, end = 0.6f, from = TransformProperties(
                translationX = peakOffsetX,
                translationY = 0f,
                scaleX = 0.15f,
                scaleY = 0.15f,
            ...
            start = 0.6f, end = 1f, from = TransformProperties(
                translationX = overshootOffsetX,
                translationY = 0f,
                scaleX = 0.475f,
                scaleY = 0.475f,
    ...
    @Composable
    override fun animate(progress: State<Float>): Modifier = Modifier.animateKeyframe(
        progress = progress,
        keyframes = keyframes,
